...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-black">
      {/* Futuristic City Background Image */}
      ...
      {/* Gradient Overlay - combined into one layer */}
      <div 
        className="absolute inset-0 z-[1]"
        style={{
          background: `
            linear-gradient(to top, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.3) 40%, rgba(0,0,0,0.4) 100%),
          ...
          <div className="space-y-6 text-left">
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-sans font-bold leading-[1.05] tracking-tight">
                <span className="block text-white drop-shadow-lg animate-fade-in-up" 
                      style={{ textShadow: '0 20px 40px rgba(0,0,0,0.7)', animationDelay: '0.6s', animationFillMode: 'both' }}>
                  {t("hero.headline.part1")}
                </span>
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-400 to-orange-500 drop-shadow-lg animate-fade-in-up font-caveat" 
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in-up" 
              ...
              >
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-2 border-amber-400/40 text-amber-400 hover:bg-amber-400/10 hover:text-white backdrop-blur-sm px-10 py-7 text-lg font-mono font-semibold transition-transform duration-300 hover:border-amber-400/60 hover:scale-105"
                >
